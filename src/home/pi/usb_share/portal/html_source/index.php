      ...
      <div class="row">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          ...
          <div class="show" id="div_rebuilding_usb_false">
            ...
            <div id="div_block_upload_files" class="dropzone_disabled dropzone_disabled_message hidden" >Upload disabled while Photon Mono X is <span id="print_job"></span></div>
          </div>
      ...
      async function getHostDetails() {
        ...
        req.onload = function() {
          if (req.status == 200) {
            ...
            if(obj.mono_x_enabled.toLowerCase() == "true") {
              window.setInterval("getMonoXDetails();", 5000);
            } 
          }
        }
        req.send();
